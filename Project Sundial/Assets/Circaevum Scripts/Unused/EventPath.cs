...
public class EventPath : MonoBehaviour {
    ...
    /*
    public Vector3[] timeFrame;
    public Vector3[] event1;
    public Vector3[] event2;
    public Vector3[] event3;
    public Vector3[] event4;
    public Vector3[] event5;
    public Vector3[] event6;
    */
	...
	void Start ()
    {
        coordinates = new Vector3[10080];
        //timeFrame = new Vector3[52560];
        for (int i = 0; i < 10080; i++)
        {
            coordinates[i] = new Vector3(
                (distance * Mathf.Sin(i * Mathf.PI / 180*360/365/24))-(radius * Mathf.Sin(2 * Mathf.PI * i*10 / 24 / 60)),
                (i * radius / 24),
                -(distance * Mathf.Cos(i * Mathf.PI /180*360/365/24))+(radius * Mathf.Cos(2 * Mathf.PI * i*10 / 24 / 60)));
        }
        /*

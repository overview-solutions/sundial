...
public class DayHelixFrame : MonoBehaviour
{
	...
	void Start()
    {
        ...
        coordinates = new Vector3[1098];
        
        for (int i = 0; i<= 1095; i+=3)
        {
            coordinates[i] = new Vector3(0,i*height,0);
            coordinates[i+1] = new Vector3((distance * Mathf.Sin(i/twist * Mathf.PI/180)),i*height,-(distance * Mathf.Cos(i/twist * Mathf.PI/180)));
            coordinates[i+2] = new Vector3(0,i*height,0);
        }
        /*
